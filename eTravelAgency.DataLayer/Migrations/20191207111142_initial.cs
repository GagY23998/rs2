        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CountryDetails = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CountryFavorites", x => new { x.UserId, x.CountryId });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    TransportTypeName = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransportCompanyName = table.Column<string>(nullable: true),
                    Rating = table.Column<float>(nullable: false),
                    TotalReservations = table.Column<int>(nullable: false),
                    Picture = table.Column<byte[]>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TransportCompanies_TransportTypes_TransportTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttractionDetails = table.Column<string>(nullable: true),
                    Picture = table.Column<byte[]>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TransportOffers_Cities_CityId",
                        column: x => x.CityId,
                        principalTable: "Cities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TransportOffers_TransportCompanies_TransportCompanyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PricePerPerson = table.Column<float>(nullable: false),
                    Discount = table.Column<int>(nullable: false),
                    IsActive = table.Column<bool>(nullable: false),
                    ThumbnailImage = table.Column<byte[]>(nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Ratings_TransportCompanies_TransportCompanyId",
                        column: x => x.TransportCompanyId,
                        principalTable: "TransportCompanies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    UserId = table.Column<int>(nullable: false),
                    HotelOfferId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reservations_HotelOffers_HotelOfferId",
                        column: x => x.HotelOfferId,
                        principalTable: "HotelOffers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Reservations_TransportOffers_TransportOfferId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ratings_TransportCompanyId",
                table: "Ratings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_HotelOfferId",
                table: "Reservations",
                column: "HotelOfferId");

            migrationBuilder.CreateIndex(
                name: "IX_Reservations_TransportOfferId",
                table: "Reservations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransportCompanies_TransportTypeId",
                table: "TransportCompanies",
                column: "TransportTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_TransportOffers_CityId",
                table: "TransportOffers",
                column: "CityId");

            migrationBuilder.CreateIndex(
                name: "IX_TransportOffers_TransportCompanyId",
                table: "TransportOffers",
                column: "TransportCompanyId");
